...
@register.filter
def intword_thousands(value, significant_digits=3, strip_trailing_zeros=True):
    """
...
def reguar_intword_thousands(value, significant_digits=3, strip_trailing_zeros=True):
    """
    Adaption of humanize_numbers_fp that will try to print a given number of significant digits, but sometimes more or
    less for easier reading.
